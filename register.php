                ...
                <div class="mu-contact-left">
                  <form class="contactform" method="post" action="">                  
                    <p class="comment-form-author">
                      ...
                      <input type="text" required="required" size="30" value="" name="txtName">
                    </p>
                    <p class="comment-form-email">
                      <label for="email">Email <span class="required">*</span></label>
                      <input type="email" required="required" aria-required="true" value="" name="txtEmail">
                    </p>
                    ...
                    <p class="comment-form-url">
                      ...
                      <input type="password"  required="required"  name="txtCPassword">  
                    </p>
                                    
                    <p class="form-submit">
                      <input name="submit"  value="Sign up" class="mu-post-btn" type="submit">
                    </p>
                    <p class="form-submit">
